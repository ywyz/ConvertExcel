...
newStudent = wb.create_sheet("新生")
s_process.CopyClass(small_one, small_two, middle_one, middle_two, big_one, big_two, newStudent)
# 删除分班后空行
...
newStudent = ProcessingForm.ProcessingForm(newStudent)
...
newStudent.DeleteNoneLines()
print("分班成功")
small_one.AddSorted()
small_two.AddSorted()
middle_one.AddSorted()
middle_two.AddSorted()
big_two.AddSorted()
big_one.AddSorted()
newStudent.AddSorted()
print("添加筛选成功")
# 输出各班已填表人数
